...
from panda3d.core import CollisionSphere, CollisionNode, CollisionHandlerPusher, CollisionTraverser
...
class WalkingEnemy(Enemy):
    def __init__(self, pos):
        Enemy.__init__(self, pos,
                       "Models/simpleEnemy",
                       {
                        "stand" : "Models/simpleEnemy-stand",
                        "walk" : "Models/simpleEnemy-walk",
                        "attack" : "Models/simpleEnemy-attack",
                        "die" : "Models/simpleEnemy-die",
                        "spawn" : "Models/simpleEnemy-spawn"
                        },
                       3.0,
                       7.0,
                       "walkingEnemy")
